...
// LandingHero — the first viewport anonymous visitors see.
// Communicates the GEM journey: upload screenplay → get scored → industry reaches out.
// Two frosted-glass cards on the purple gradient: script with score → producer message.
// "Get started" triggers the parent to transition to the upload flow.
...
export function LandingHero({ onGetStarted }: { onGetStarted: () => void }) {
  return (
    ...
    >
      {/* Star dots — same pattern as FormatSelectorHero */}
