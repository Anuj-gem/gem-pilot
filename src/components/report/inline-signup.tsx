  ...
  if (success) {
    return (
      <div className="rounded-xl border border-emerald-700 bg-emerald-950/30 p-4 sm:p-5">
        <p className="text-sm font-semibold text-emerald-300">You&apos;re in. Your report is saved.</p>
        <p className="text-xs text-emerald-400/80 mt-1 mb-3">
          Upgrade to unlock your full score and publish your best work to the leaderboard.
        </p>
        <button
          type="button"
        ...
        >
          Publish to the leaderboard — $20/mo
          <ArrowRight size={14} />
        </button>
      </div>
    )
  ...
  return (
    <div className="rounded-xl border border-[var(--gem-gray-600)] bg-[var(--gem-gray-900)] p-4 sm:p-5">
      <h3 className="text-sm font-bold text-[var(--gem-white)] mb-1">
        Claim your report — then publish to the leaderboard.
      </h3>
      <p className="text-xs text-[var(--gem-gray-400)] mb-4">
        A free account keeps your report forever. Upgrade to unlock your full score and publish your best scripts to the leaderboard.
      </p>
