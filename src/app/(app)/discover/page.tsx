// /discover — public project directory (canonical URL).
//
...
// Anuj 2026-06-03 — moved from /leaderboard to /discover (canonical).
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Explore projects from the GEM community.',
    siteName: 'GEM',
    url: 'https://www.gem.studio/discover',
    type: 'website',
  },
  twitter: {
...
export default async function DiscoverPage({ searchParams }: PageProps) {
  ...
  const initialSort = (['recent', 'top_gem', 'top_heat'].includes(sp.sort || '')
    ? sp.sort
    : 'recent') as 'recent' | 'top_gem' | 'top_heat'
