...
// OnboardingAccountClient — Path B account creation. Simpler than
// /submit's AccountStep because there's no submission/eval to claim:
// we just create the account and route to /onboarding/privacy.
//
// Google OAuth round-trip: stash a 'next' marker in localStorage so the
// /auth/callback handler routes the user back into /onboarding instead
// of dropping them on /dashboard.
//
      ...
      <div className="max-w-[420px]">
        ...
        <form onSubmit={handleEmailSignup} className="space-y-2.5">
          ...
          >
            ...
            {signingUp ? 'Creating your account…' : 'Continue →'}
          </button>
        </form>
      </div>
    </OnboardingShell>
